...
1. Build a topic-topic PMI co-occurrence graph over the cohort's tagged
   ...
   same cached `topics` field as scripts/13_semantic_edges.py, no new
   ...
   codebase's usual min-shared threshold, see compute_shared_edges.py) --
...
Usage: python3 scripts/16_topic_circular_embedding.py
"""
import json
import math
import sys
