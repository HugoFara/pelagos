...
Rust repos (scripts/34_fetch_rust_ecosystem_repos.py) arrive with zero
...
see 32_fetch_java_manifests.py) and real TOML, so the stdlib `tomllib`
...
Usage: python3 scripts/35_fetch_cargo_toml.py
"""
import base64
import json
import subprocess
