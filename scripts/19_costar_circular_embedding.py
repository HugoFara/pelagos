...
Unlike scripts/16_topic_circular_embedding.py, no aggregation step is
...
is already a *repo-repo* graph (scripts/14_cluster_hierarchy.py's
...
See scripts/20_compare_theta_sources.py for the evaluation this feeds and
NOTES.md for the result.

Usage: python3 scripts/19_costar_circular_embedding.py
"""
import json
import math
import sys
...
def main():
    cluster_mod = __import__("14_cluster_hierarchy")
    cohort = load_cohort()
