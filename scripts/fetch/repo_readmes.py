...
descriptions alone (already cached, scripts/fetch/repo_descriptions.py)
...
surface needed beyond what dependency_repos.py and repo_descriptions.py
already use.

Cached raw (before any cleaning -- see scripts/layout/text_embeddings.py for the
...
Usage: python3 scripts/fetch/repo_readmes.py
"""
import base64
import json
import subprocess
...
GH_API_THROTTLE_S = 0.4  # see scripts/cohort/dependency_repos.py -- an unthrottled
