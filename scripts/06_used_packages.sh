...
# scripts/find_repos_with_packages.sh before assuming a given repo has data here.
# Usage: SEMREPO_NT=/path/to/SemRepo.nt ./06_used_packages.sh repo_list.txt > data/raw/repo_packages.nt
set -euo pipefail
