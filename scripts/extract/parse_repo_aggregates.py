#!/usr/bin/env python3
"""Parse data/raw/repo_aggregates.nt (from scripts/extract/repo_aggregates.sh) into
data/processed/repo_aggregates.json: {repo: {title, stargazers, forks,
openIssues, watchers, contributors}}.

Usage: python3 scripts/extract/parse_repo_aggregates.py repo_list.txt raw/repo_aggregates.nt processed/repo_aggregates.json
"""
import json
import sys
