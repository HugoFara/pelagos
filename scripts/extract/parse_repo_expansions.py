#!/usr/bin/env python3
"""Parse data/raw/repo_expansions.nt (from scripts/extract/repo_expansions.sh) into
...
scripts/lib/shared_edges.py.

Usage: python3 scripts/extract/parse_repo_expansions.py raw/repo_expansions.nt processed/repo_expansions.json
"""
import json
import sys
...
from lib.ntparse import parse_line, short_predicate, repo_name, object_type_label  # noqa: E402
