...
Output shape matches 29/31/33/36/38: [source, target, weight, [coordinates]],
weight = how many distinct submodules/ports/packages of that target this
repo depends on. Folded into the one shared top-K prune by
11_dependency_edges.py.

Usage: python3 scripts/41_cpp_dependency_edges.py [out=data/processed/repo_cpp_dependency_edges.json]
"""
import json
import re
import sys
...
REGISTRY_THROTTLE_S = 0.2  # raw.githubusercontent.com; same order as 09/31/33
