...
JS/TS repos (scripts/24_fetch_js_ecosystem_repos.py) currently have zero
...
29_go_dependency_edges.py), just resolved via the npm registry instead of
...
Usage: python3 scripts/30_fetch_package_json.py
"""
import base64
import json
import subprocess
