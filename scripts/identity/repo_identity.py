...
evidence that can actually settle its case:
  ...
  3. **Mirrors and unlinked copies** -- intrinsic git object ids, from
     scripts/identity/repo_refs.py. Nothing on GitHub links a mirror to its upstream, and
...
Once scripts/identity/apply_identity.py has collapsed a duplicate out of the cohort, that
...
Usage: python3 scripts/identity/repo_identity.py
"""
import json
import subprocess
import sys
