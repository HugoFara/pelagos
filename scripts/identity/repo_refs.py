...
scripts/identity/repo_identity.py is the derive half.
...
scripts/identity/repo_identity.py uses it for exactly that, on a bounded subset.
...
Usage: python3 scripts/identity/repo_refs.py [limit=0]
"""
import json
import subprocess
import sys
...
def canonical_url(repo):
    ...
    aggregate row scripts/cohort/forge_repo_stats.py wrote. Building a github.com
