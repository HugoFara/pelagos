...
Usage: SEMREPO_NT=/path/to/SemRepo.nt python3 scripts/cohort/dependency_repos.py [top_n_source=100]
"""
import json
import os
import subprocess
...
def dump_aggregates(nt_path, repo_ids):
    ...
    list -- same approach as scripts/extract/repo_aggregates.sh, generalized to a list
...
def main(top_n_source="100"):
    ...
    if not nt_path:
        sys.exit("usage: SEMREPO_NT=/path/to/SemRepo.nt python3 scripts/cohort/dependency_repos.py [top_n_source]")
