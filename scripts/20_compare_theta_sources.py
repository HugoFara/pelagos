...
(scripts/19_costar_circular_embedding.py) correlate with genuine relatedness
better than the topic-PMI-driven theta Phase 12 shipped
(scripts/16_topic_circular_embedding.py)? "Better" needs an actual metric,
...
Usage: python3 scripts/20_compare_theta_sources.py
"""
import json
import math
import sys
