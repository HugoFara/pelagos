...
Go repos (scripts/27_fetch_go_ecosystem_repos.py) currently have zero
dependency edges: 11_dependency_edges.py's usedPackage signal comes from the
...
resolving to a GitHub repo (09_resolve_packages.py). See
29_go_dependency_edges.py for the parsing/resolution that turns this into
real repo-repo edges.

Unlike scripts/17_fetch_readmes.py's `repos/{o}/{r}/readme` (which finds
...
Usage: python3 scripts/28_fetch_go_mod.py
"""
import base64
import json
import subprocess
