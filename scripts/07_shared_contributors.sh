...
# <repository/X> <predicate> <person/Y> shape compute_shared_edges.py expects --
...
#
# Usage: SEMREPO_NT=/path/to/SemRepo.nt ./07_shared_contributors.sh repo_list.txt > data/raw/repo_contributors_full.nt
set -euo pipefail
