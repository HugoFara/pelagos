...
titles (scripts/edges/shared_issue_authors.py) as a fourth input where available --
...
Usage: python3 scripts/layout/text_embeddings.py
"""
import json
import re
import sys
...
# ROADMAP.md Phase 19: a repo's sampled issue titles (scripts/edges/shared_issue_authors.py)
...
# this dump at all) so a from-scratch run before shared_issue_authors.py exists degrades
