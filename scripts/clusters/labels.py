...
scripts/layout/text_embeddings.py already cleaned and cached), reduced to
...
Runs after scripts/clusters/stabilize_ids.py, and depends on it: labels
...
Usage: python3 scripts/clusters/labels.py
"""
import json
import math
import re
...
from layout import text_embeddings as text_mod  # noqa: E402
