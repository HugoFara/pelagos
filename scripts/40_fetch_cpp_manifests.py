...
unlike 28/30/32/35 this looks for four different files and keeps *every*
...
fetch-all shape as 37_fetch_python_manifests.py, which needed it for the
...
trade -- see 41_cpp_dependency_edges.py.
...
Usage: python3 scripts/40_fetch_cpp_manifests.py
"""
import base64
import json
import subprocess
